...
export default function ResetPassword() {
  ...
  const handleReset = async () => {
    ...
    setLoading(true);
    try {
      // token acts as the "otp" field — backend's resetPassword accepts both
      await api.post("/api/auth/reset-password", { email, otp: token, newPassword });
      setStep("success");
    } catch (err) {
      setError(
      ...
      <div className="fp-card">
        ...
        {step === "form" && (
          <>
            ...
            <button className="fp-send-btn" onClick={handleReset} disabled={loading}>
