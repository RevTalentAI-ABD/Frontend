...
const getGreeting = () => {
  ...
  const { data: employees,loading: l4 }             = useFetch(employeeAPI.getAll);
  ...
  const deptMap = {};
  (employees || []).forEach(e => {
    deptMap[e.department || e.dept] = (deptMap[e.department || e.dept] || 0) + 1;
  });
    ...
    <div className="hr-page">
     ...
     <div className="hr-panel">
       ...
       <div className="hr-quick-actions">
         {[
           { icon: <UserPlus size={18} />, label: "Add Employee",  page: "employees" },
           { icon: <ClipboardList size={18} />, label: "Review Leaves", page: "leaves" },
           { icon: <Wallet size={18} />, label: "Run Payroll",   page: "payroll" },
           { icon: <Briefcase size={18} />, label: "Post Job",   page: "recruitment" },
           { icon: <BarChart3 size={18} />, label: "View Reports", page: "reports" },
